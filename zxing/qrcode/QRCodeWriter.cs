...
namespace com.google.zxing.qrcode
{
	...
	public sealed class QRCodeWriter : Writer
	{
        ...
        public System.Drawing.Size GetEncodeSize(System.String contents, BarcodeFormat format, int width, int height, System.Collections.Hashtable hints)
        {
            ...
            QRCode code = new QRCode();
            Encoder.encode(contents, errorCorrectionLevel, hints, code);
            return renderResultSize(code, width, height);
        }

        // Note that the input matrix uses 0 == white, 1 == black, while the output matrix uses
		// 0 == black, 255 == white (i.e. an 8 bit greyscale bitmap).
        private static System.Drawing.Size renderResultSize(QRCode code, int width, int height)
        {
            ...
            return new System.Drawing.Size(inputWidth * multiple, inputHeight * multiple);
